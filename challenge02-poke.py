...
dataSet = [
        {"ability": {"name": "static", "attack type": "electric"}, "is_hidden": False, "slot":1},
        {"ability": {"name": "lightning-rod", "attack type": "electric"}, "is_hidden": True, "slot": 3}
          ]
...
# use a for loop to display JUST the attack type of a single ability
for ability in dataSet:
    print(ability.get("ability").get("attack type"))
